function HomeFeed() {
    return (
        <feed className="feed">
            <div>
                <button
                    className="feed-create-post-button"
                    onClick="createPost()">
                    Create Post
                </button>
            </div>
            ...
            <post className="posts" id="$postid">
                        ...
                        <div className="post-info">
                            ...
                            <div className="choices">
                                <div className="comment-post-options">
                                    <button
                                        id="likePostButton"
                                        className="like icons post-$postid active"
                                        onClick="toggleHeart($postid);handleLikeButtonClick($postid);"></button>
                                    <button
                                        id="likePostButton"
                                        ...
                                        <span className="likeCounter $postid">
                                            $likesCount
                                        </span>
                                    </button>
                                    <button>
                        ...
                        <div className="comment-container">
                            ...
                            <div>
                                <div className="comment-text">
                                    ...
                                    adipisicing elit. Deserunt animi obcaecati
                                    quidem nostrum commodi tenetur?
                                </div>
                                ...
                                <div className="comment-replies-container">
                                    <div className="comment-text">
                                        <p>
                                            ...
                                            interdum, nisi lorem egestas vitae
                                            scel
                                            <span id="dots">...</span>
                                            <span id="more">
                                                erisque enim ligula venenatis
                                                dolor. Maecenas nisl est,
                                                ultrices nec congue eget, auctor
                                                vitae massa. Fusce luctus
                                                vestibulum augue ut aliquet.
                                                Nunc sagittis dictum nisi, sed
                                                ullamcorper ipsum dignissim ac.
                                                In at libero sed nunc venenatis
                                                imperdiet sed ornare turpis.
                                                Donec vitae dui eget tellus
                                                gravida venenatis. Integer
                                                fringilla congue eros non
                                                fermentum. Sed dapibus pulvinar
                                                nibh tempor porta.
                                            </span>
                                        </p>
                ...
                <div className="feed-post">
                    ...
                    <button
                        ...
                        data-postid="$postid">
                        <img className="post-image" src="$post_image_path" />
                    </button>
                    <div className="choices">
