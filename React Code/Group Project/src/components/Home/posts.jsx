                                ...
                                <div className="comment-text">
                                    <p>
                                        ...
                                        <span id="more">
                                            ...
                                            aliquet. Nunc sagittis dictum nisi,
                                            sed ullamcorper ipsum dignissim ac.
                                            In at libero sed nunc venenatis
                                            imperdiet sed ornare turpis. Donec
                                            vitae dui eget tellus gravida
                                            venenatis. Integer fringilla congue
                                            eros non fermentum. Sed dapibus
                                            pulvinar nibh tempor porta.
                                        </span>
                                    </p>

                                    <button onClick="toggleMore()" id="myBtn">
                                        Read more
                                    </button>
                                </div>
                                <div className="comment-options">
