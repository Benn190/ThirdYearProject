...
<main>
    ...
    <section class="settingsContent">
        ...
        <div id="account">
            <span class="updateTitle">Account</span>
            <div class='divider'></div>
            <div class="info-display">
                <p class="info-cat">Username -</p>
                <p>
                    <?php echo $username ?>
                </p>
            ...
            <div class="info-display">
                <p class="info-cat">Account Type -</p>
                <p>
                    <?php echo "Name changed in database?" ?>
                </p>
        ...
        <div id="updateEmail">
            <span class="updateTitle">Update Email</span>
            <div class='divider'></div>
        ...
        <div id="updateBio">
            <span class="updateTitle">Update Bio</span>
            <div class='divider'></div>
        ...
        <div id="updateName">
            <span class="updateTitle">Update Name</span>
            <div class='divider'></div>
            <form action="../php/update_name.php" method="post">

                <div class="info-display">
                    <p class="info-cat">Current Name -</p>
                    <p>
                        <?php echo "$name" ?>
                    </p>
        ...
        <div id="updatePassword">
            <span class="updateTitle">Reset Password</span>
            <div class='divider'></div>
            <form action="">
