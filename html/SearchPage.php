    ...
    <main>
        ...
        <feed class="feed">
            ...
            if (isset ($_POST['searchWord']) && !empty ($_POST['searchWord'])) {
                ...
                $profileSearchListRESULT = pg_query($conn, $profileSearchListQuery);
                $groupSearchListRESULT = pg_query($conn, $groupSearchListQuery);

                $postsLikeListRESULT = pg_query($conn, $postsLikeListQuery);
                $profileLikeSearchListRESULT = pg_query($conn, $profileLikeSearchListQuery);
                $groupLikeSearchListRESULT = pg_query($conn, $groupLikeSearchListQuery);

                $postsTagsRESULT = pg_query($conn, $postsTagsListQuery);
            ...
            <div class='comments-column'>
                ...
                if ($profileSearchListRESULT) {
                    while ($row = pg_fetch_assoc($profileSearchListRESULT)){
                        $profile_name = $row["name"];
                        $profile_username = $row["username"];

                        echo "<post class='posts' id=$username>";
                        echo " <prepost>
                        <div class = 'feed-post'>
                        <div class='user-container'>
                            <a href='Profile.php?id=$profile_username'><img src='../images/icons/Unknown_person.jpg' class='post-avatar' style='width: 100px; height: 100px;' /></a>
                            <div class='user-post-name'>
                                <span style = 'font-size: 30px;'>$profile_name</span>
                        ...
                        echo "<div class='feed-post'>";
                        echo "<div class='user-container'>";
                        echo "<a href='Profile.php?id=$profile_username'><img src='../images/icons/Unknown_person.jpg' class='post-avatar' style='width: 100px; height: 100px;' /></a>";
                        echo "<div class='user-post-name' style = 'padding : 5px;'>";
                        echo "<span style = 'font-size: 30px;'>$profile_name</span>";
                        echo "<span style = 'font-size: 15px;'>@$profile_username</span>";
                        echo "</div>";
                        echo "</div>";
                        echo "</div>";
                        echo "</post>";
                ...
                if ($groupSearchListRESULT) {
                    while ($row = pg_fetch_assoc($groupSearchListRESULT)){
                        $group_ID = $row["groupid"];
                        $group_manager = $row["managerid"];
                        $group_name = $row["groupname"];
                        $group_description = $row["description"];

                        echo "<post class='posts' id=$group_ID >";
                        echo " <prepost>
                        <div class = 'feed-post'>
                        <div class='user-container'>
                            <div class='user-post-name'>
                                <span style = 'font-size: 30px;'>$group_name</span>
                                <span style = 'font-size: 15px;'>Group Manager: $group_manager</span>
                                <span style = 'font-size: 15px;'>$group_description</span>
                            </div>
                        </div>
                        </div>
                        </prepost>";
                        ...
                        echo "<div class='user-container'>";
                        echo "<div class='user-post-name' style = 'padding : 5px;'>";
                        echo "<span style = 'font-size: 30px;'>$group_name</span>";
                        echo "<span style = 'font-size: 15px;'>Group Manager: $group_manager</span>";
                        echo "<span style = 'font-size: 15px;'>$group_description</span>";
                        echo "</div>";
                        echo "</div>";
                        echo "</div>";
                        echo "</post>";
                ...
                if ($postsLikeListRESULT) {
                    // Output data of each row
                    while ($row = pg_fetch_assoc($postsLikeListRESULT)) {
                        $text = $row["text"];
                        $poster_username = $row["username"];
                        $name = $row["name"];
                        $postid = $row["postid"];
            ...
            <div class='comments-column'>
                ...
                //posts like match
                if ($profileLikeSearchListRESULT) {
                    while ($row = pg_fetch_assoc($profileLikeSearchListRESULT)){
                        $profile_name = $row["name"];
                        $profile_username = $row["username"];
                ...
                if ($groupLikeSearchListRESULT) {
                    while ($row = pg_fetch_assoc($groupLikeSearchListRESULT)){
                        $group_ID = $row["groupid"];
                        $group_manager = $row["managerid"];
                        $group_name = $row["groupname"];
                        $group_description = $row["description"];
                ...
                if ($postsTagsRESULT) {
                    // Output data of each row
                    while ($row = pg_fetch_assoc($postsTagsRESULT)) {
                        $text = $row["text"];
                        $poster_username = $row["username"];
                        $name = $row["name"];
                        $postid = $row["postid"];
