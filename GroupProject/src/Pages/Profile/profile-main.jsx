    ...
    return (
        <>
            <main>
                ...
                <section className="profile-info-display">
                    <aside className="profile-bio">
                        ...
                        <bio>
                            ...
                            elit. Amet cupiditate doloremque illo enim quibusdam
                            totam error excepturi odit pariatur fugiat vero hic,
                            velit fugit tenetur.
                        </bio>
                        <div>
                            <span>IMG</span>
                ...
                <section className="profile-info-groups">
                    <div className="profile-info-groups-container">
                        <div className="profile-info-groups-group-container">
                            <img
                                className="profile-info-groups-group"
                                src="../images/f1.png"></img>
                            <a className="profile-info-groups-name">
                                Group Name
                            </a>
                        </div>
                    </div>
